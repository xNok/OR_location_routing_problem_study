...
def extract_problem(xy_customers, xy_icps, xy_crcs, xy_pc, q):
    ...
    xy_j_c = xy_icps+xy_crcs # j vaule fist, c value second
    ...
    DjUc = [[m.sqrt((c[0]-j[0])**2 + (c[1]-j[1])**2) for c in xy_j_c] for j in xy_j_c ]
    ...
    return I,J,C,B,K,V,W,DjUc,Dcj,Dc,FCV,FCT,FCR,U